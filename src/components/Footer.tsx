...
const Footer = () => (
  <footer className="bg-background border-t border-border mt-8 hidden md:block">
    <div className="container mx-auto py-8 px-4">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Your ultimate anime tracking and discovery platform. Keep up with your favorite shows and find new ones!
          </p>
        </div>

        <div>
          <h3 className="font-semibold mb-4 text-gray-800 dark:text-gray-200">Navigation</h3>
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link href="/my-list" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                My List
              </Link>
            </li>
            <li>
        ...
        <div>
          <h3 className="font-semibold mb-4 text-gray-800 dark:text-gray-200">Resources</h3>
          <ul className="space-y-2 text-sm">
            <li>
        ...
        <div>
          <h3 className="font-semibold mb-4 text-gray-800 dark:text-gray-200">Connect</h3>
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500 dark:text-gray-400">
        &copy; {new Date().getFullYear()} Animeeeeeww. All rights reserved.
      </div>
    </div>
  </footer>
);
